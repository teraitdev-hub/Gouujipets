        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center space-y-6">
          ...
          >
            <form onSubmit={handleSearch} className="flex flex-col sm:flex-row items-stretch gap-2 bg-white/90 backdrop-blur-md p-2 rounded-2xl border border-slate-200/80 shadow-xl focus-within:ring-2 focus-within:ring-purple-500/20 focus-within:border-purple-400 transition-all z-20 relative">
              ...
              {/* Massive Zomato-style Location Button */}
              <div className="flex items-center w-full sm:w-[35%] border-b sm:border-b-0 sm:border-r border-slate-200 px-2 py-1">
                <button
                  type="button"
                  onClick={() => setHeroLocationSheetOpen(true)}
                  className="w-full flex items-center justify-between gap-2 px-3 py-3 rounded-xl hover:bg-slate-50 transition-colors group"
                >
                  <div className="flex items-center gap-3 overflow-hidden">
                    ...
                    <div className="flex flex-col items-start min-w-0">
                      <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">
                        {isDetecting ? 'Detecting...' : 'Your Location'}
                      </span>
                      <span className="text-sm font-black text-slate-900 truncate w-full text-left">
              ...
              {/* Search Input */}
              <div className="flex items-center w-full flex-1 gap-3 px-4 py-3">

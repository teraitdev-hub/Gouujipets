...
const filePath = 'c:\\Users\\hp\\Desktop\\pet business\\src\\pages\\PublicHome\\PublicHome.tsx';
...
const newJsx = `return (
    <div className="font-sans bg-white overflow-hidden">
      ...
      <section className="relative pt-16 lg:pt-24 pb-32 px-4 sm:px-6 lg:px-8 bg-petwise-bg">
        <div className="max-w-7xl mx-auto relative z-10 flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-8">
          ...
          <div className="flex-1 text-center lg:text-left space-y-6">
            <div className="relative inline-block">
              ...
              {/* Decorative sparks */}
              <div className="absolute top-0 right-0 sm:-right-10 text-petwise-brown hidden sm:block opacity-50 text-2xl">✨</div>
            </div>
            ...
            >
              <form onSubmit={handleSearch} className="flex flex-col sm:flex-row items-stretch gap-2 bg-white p-2 rounded-full border border-slate-200/80 shadow-xl focus-within:ring-2 focus-within:ring-petwise-brown/20 transition-all z-20 relative">
                ...
                <div className="flex items-center w-full sm:w-[40%] border-b sm:border-b-0 sm:border-r border-slate-200 px-2 py-1">
                  ...
                  >
                    <MapPin size={18} className="text-petwise-brown shrink-0" />
                ...
                <button type="submit" className="w-full sm:w-auto bg-petwise-brown hover:bg-petwise-brown-hover text-white font-black px-6 py-3 rounded-full transition-all active:scale-95 shrink-0 whitespace-nowrap">
                  Our Services
                </button>
              </form>
            </motion.div>
          ...
          >
            ...
            <div className="absolute inset-0 rounded-full border-[8px] border-dashed border-petwise-brown/20 animate-spin-slow"></div>
        ...
        {/* Wavy bottom divider */}
        <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none z-0 transform translate-y-px">
          <svg className="relative block w-full h-[60px] sm:h-[100px]" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
            <path d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V120H0V95.8C59.71,118,130.81,119.56,192.39,105.46,236.21,95.53,280.4,75.12,321.39,56.44Z" fill="#ffffff"></path>
          </svg>
        </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-white">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 max-w-5xl mx-auto">
          ...
          >
            <div className="w-32 h-32 sm:w-40 sm:h-40 rounded-full bg-petwise-peach flex flex-col items-center justify-center p-4 transition-transform group-hover:-translate-y-2 group-hover:shadow-xl">
              <span className="text-4xl mb-2">🏠</span>
              <h3 className="font-black text-black text-sm sm:text-base">Pet Boarding</h3>
          ...
          <div
            ...
            className="group cursor-pointer flex flex-col items-center text-center"
          >
            <div className="w-32 h-32 sm:w-40 sm:h-40 rounded-full bg-petwise-pink flex flex-col items-center justify-center p-4 transition-transform group-hover:-translate-y-2 group-hover:shadow-xl">
              <span className="text-4xl mb-2">💇</span>
          ...
          <div
            ...
            className="group cursor-pointer flex flex-col items-center text-center"
          >
            <div className="w-32 h-32 sm:w-40 sm:h-40 rounded-full bg-petwise-yellow flex flex-col items-center justify-center p-4 transition-transform group-hover:-translate-y-2 group-hover:shadow-xl">
              <span className="text-4xl mb-2">🌞</span>
              <h3 className="font-black text-black text-sm sm:text-base">Pet Daycare</h3>
          ...
          <div
            ...
            className="group cursor-pointer flex flex-col items-center text-center"
          >
            <div className="w-32 h-32 sm:w-40 sm:h-40 rounded-full bg-petwise-green flex flex-col items-center justify-center p-4 transition-transform group-hover:-translate-y-2 group-hover:shadow-xl">
              <span className="text-4xl mb-2">🩺</span>
        ...
        <div className="mt-12 text-center">
          <button 
            onClick={() => navigate('/boarding')}
            className="bg-petwise-brown hover:bg-petwise-brown-hover text-white font-bold px-8 py-3.5 rounded-lg shadow-md transition-colors"
          >
            See All Services
          </button>
        </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#fbfbfb]">
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="flex-1 relative w-full max-w-md mx-auto">
            <div className="absolute -top-10 -left-10 text-petwise-brown opacity-40 text-4xl hidden sm:block">✨</div>
            {/* Arch shaped container */}
            <div className="w-full aspect-[3/4] bg-petwise-brown/10 rounded-t-full rounded-b-[40px] overflow-hidden relative shadow-2xl">
              <img 
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
              {[
                ...
                <div key={i} className="flex items-center gap-2">
                  <span className="text-petwise-brown text-sm">🐾</span>
      ...
      <section className="py-16 px-4 sm:px-6 max-w-7xl mx-auto bg-white">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            onClick={() => navigate('/boarding')}
            className="text-petwise-brown hover:text-petwise-brown-hover font-bold text-sm flex items-center gap-1"
          >
        ...
        {isLoading ? (
          ...
          <div className="bg-slate-50 rounded-[32px] p-10 text-center max-w-md mx-auto">
            ...
            <button 
              ...
              className="px-6 py-3 rounded-xl bg-petwise-brown hover:bg-petwise-brown-hover transition-colors text-white font-bold"
            >
              Reset Search
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {filteredFacilities.slice(0, 4).map((facility, idx) => (
              <motion.div
                ...
                className="group bg-white rounded-[32px] border border-slate-100 hover:-translate-y-2 hover:shadow-2xl hover:border-petwise-brown/30 transition-all duration-300 flex flex-col justify-between overflow-hidden cursor-pointer"
              >
                ...
                <div className="p-5 flex-1 flex flex-col justify-between gap-3">
                  <div>
                    <h3 className="font-black text-slate-900 text-lg group-hover:text-petwise-brown transition-colors truncate">
                      {facility.name}
                    </h3>
                  ...
                  <div className="flex items-center justify-between border-t border-slate-100 pt-4">
                    ...
                    <button className="w-10 h-10 rounded-full bg-slate-50 group-hover:bg-petwise-brown group-hover:text-white flex items-center justify-center transition-colors">
...
console.log('Successfully updated PublicHome.tsx');
